...
5. Press **Activate / Update Main HU**.

## First-time activation

If EDGE is not already the active live wallpaper:
...
- MP4 is recommended.
- Use the same aspect ratio as the HU display to avoid stretched circles or vehicles.
- Audio is muted and the video loops automatically.
- Keep file sizes moderate for smooth startup and lower storage use.

## Recovery

Use **Factory Wallpapers** inside EDGE to return control to the original Geely wallpaper mode.
